import { ProductsType, ProductType, BasketProductType } from '../types/types'
export const uuid = require('uuid');


const itemPizza: ProductType[] = [
  {
    id: uuid.v1(),
...
export const productCoffee: ProductType[] = [
  {
    id: uuid.v1(),
...
export const products: ProductsType = {
  itemPizza: itemPizza,
  itemCoffee: productCoffee,
  itemCocktail: productСocktail
}
...
export const basket: BasketProductType[] = []
